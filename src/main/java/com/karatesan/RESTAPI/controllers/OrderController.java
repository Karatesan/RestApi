...
import com.karatesan.RESTAPI.exceptions.OrderNotFoundException;
import com.karatesan.RESTAPI.model.Order;
import com.karatesan.RESTAPI.modelAssemblersHATEOAS.OrderModelAssembler;
...
public class OrderController {
	...
	public CollectionModel<EntityModel<Order>>all(){
		...
		List<EntityModel<Order>> entityModels = repository.findAll().stream().map(assembler::toModel).collect(Collectors.toList());
		return CollectionModel.of(entityModels,WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn( OrderController.class).all()).withSelfRel());
